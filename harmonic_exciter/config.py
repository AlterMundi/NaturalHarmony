...
# Bottom row of Launchpad Mini (live/default mode): pads map to tines 0-4
# Notes 48-52 = bottom row in default mode (not programmer mode).
LAUNCHPAD_TINE_PADS = [48, 49, 50, 51, 52]
